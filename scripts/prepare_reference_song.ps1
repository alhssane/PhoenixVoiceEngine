...
param(
    ...
    [string]$ProjectName = 'freed_joud_reference',
    [Parameter(Mandatory=$false)]
    [string]$ArtistName = 'freed_joud'
)
...
# Ensure the current checkout has the orchestration tree needed by the reference pipeline.
